...
<body>
    ...
    <?php
            ...
            $str_query = "insert into customer1 values('$NamaDepan','$NamaTengah','$NamaBelakang','$TempatLahir','$TglLahir',
            '$NIK','$WargaNegara','$Email','$NoHp','$Alamat','$KodePos','$FileName','$Username','$Password1','$Password2')";
